...
epoch = 30  #Initializing epochs and batch size. Epoch size is large because we have used Earlystopping during training which can halt the training process if required
Batch_size = 8
